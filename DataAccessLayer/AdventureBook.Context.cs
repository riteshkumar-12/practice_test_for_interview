...
namespace Practice.DataAccessLayer
{
    ...
    public partial class AdventureWorks2017Entities : DbContext
    {
        ...
        public virtual ObjectResult<ProcedureReturnMultipleColumns_Result> ProcedureReturnMultipleColumns(Nullable<int> businessId, string firstName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ProcedureReturnMultipleColumns_Result>("ProcedureReturnMultipleColumns", businessIdParameter, firstNameParameter);
        }

        public virtual int udf_MyProcedure()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("udf_MyProcedure");
        }

        public virtual int udf_MyProcedure2()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("udf_MyProcedure2");
        }

        public virtual int usp_MyTestProceduredivide(Nullable<decimal> a, Nullable<decimal> b, ObjectParameter c)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_MyTestProceduredivide", aParameter, bParameter, c);
        }
